    ...
    <div className='container-fluid' style={{
       ...
       <div className='row' style={{
                    ...
                    <li style={{listStyle:'none'}} className='mr-2'>
                        ...
                        <li className='mr-5' style={{listStyle:'none'}}>
                            <Link to='/profile' className='text-light'>
                                <p>{user && user.name.toString().toUpperCase()} </p>
                            </Link>
                        </li>
        ...
        <div className='col-sm-3 col-xs-12 text-center'>
            ...
            <button className='btn btn-rounded btn-lg text-light  btnGoldPack-alt' >Enroll</button>
            </div>
        </div>
...
export default connect(mapStateToProps,{loadUser})(RegisteredHome);
